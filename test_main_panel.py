...
'''
version = '1.0.0.26'  # Необходимо указать актуальную версию конифгуратора для проверки соотвествия
...
def unload_setting(page):
    ...
    page.check_unload(ppk_num, areas + inlinks + outlinks, BIS_Ms * 2, addr_devs * 3)
    page.close_terminal()